...
# Chan 250804
from mppi_solver.src.solver_v2.sampling.standard_normal_noise import StandardSamplling
...
class MPPI():
    ...
    def MATLAB_log(self):
        ...
        self.matlab_logger.log("sigma", [self.sim_time.time] + torch.diag(self.sampling.sigma).tolist())
