...
def generate_launch_description():
    ...
    leo_model = os.path.join(canadarm_demos_path, 'worlds', 'simple_wo_iss_no_earth.world')
    ...
    debris_list = [
        ...
        {'name': 'ball3', 'x':  '2.0', 'y':  '3.0', 'z': '6.0'},
        {'name': 'ball4', 'x': '-3.0', 'y':  '3.0', 'z': '3.0'},
        {'name': 'ball5', 'x': '-5.0', 'y':  '3.0', 'z': '7.0'},
    ]
